 ...
 * @author 52417
 */
public class jifAgregarAlExtraviado extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setResizable(true);
        setTitle("Animal extraviado - Agregar");
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblSub2, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSeleccionarFotoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarFotoActionPerformed
        ...
        if (archivo == null || archivo.getName().trim().equals("") || archivo.length() > 1048576) {
            ...
            try {
                ...
                System.out.println("Error en jifAgregarAExtraviado.btnSeleccionarFoto:\n" + ex.getMessage());
            }
    ...
    private void agregar() {
        ...
        perdido.setAnimal_idAnimal(animal.regresarId());
        System.out.println(animal.regresarId());
        if (perdido.agregar().startsWith("Se agrego:") && comp) {
            validar.agregarRecordatorio(txtNombre.getText(), "Extraviados");
